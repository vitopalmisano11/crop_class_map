...
@st.cache_data
def load_data():
    # Sostituisci questo blocco con il caricamento del tuo file, es:
    gdf_fields = gpd.read_file("./data/icolt2025_web/iCOLT2025_ER_vec_unione/iCOLT2025_ER_vec_HAgt05_clean.shp")
    gdf_fields.to_crs(epsg=4326, inplace=True)
    crop_class_map = {
        1: "colture estive",
    ...
    gdf_fields["crop_class"] = gdf_fields.apply(lambda row: crop_class_map[row.ID_CROP], axis=1)
